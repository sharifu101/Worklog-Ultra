  ...
  return (
    ...
    >
      <Dialog.Trigger asChild>
        <Button
          className="button-force-white inline-flex items-center gap-2 rounded-2xl bg-[#4f5ef7] px-5 py-3 text-sm font-semibold text-white shadow-[0_16px_35px_rgba(79,94,247,0.24)] transition hover:bg-[#4453eb]"
          type="button"
        >
