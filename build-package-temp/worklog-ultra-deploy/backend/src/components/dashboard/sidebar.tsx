...
import { BellRing, BriefcaseBusiness, CalendarCheck2, CheckSquare2, ClipboardList, FileClock, FolderTree, HelpCircle, LayoutDashboard, ListTodo, LogOut, Menu, MessageSquareMore, Repeat2, Shield, UserRoundSearch, Users, X } from "lucide-react";
...
const navItems = [
  ...
  { href: "/dashboard/recurring", icon: Repeat2, label: "Recurring" },
  ...
  { href: "/dashboard/directory", icon: UserRoundSearch, label: "Others Plan" },
...
export function Sidebar({ user }: { user: SidebarUser }) {
  ...
  return (
    <aside className="sticky top-0 hidden h-screen w-[250px] shrink-0 border-r border-[#162945] bg-[linear-gradient(180deg,#091427_0%,#0d1a2f_100%)] p-4 lg:flex lg:flex-col">
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-y-0 left-0 z-50 flex w-[88vw] max-w-[320px] flex-col overflow-y-auto border-r border-[#162945] bg-[linear-gradient(180deg,#091427_0%,#0d1a2f_100%)] p-4 shadow-[0_30px_90px_rgba(3,8,18,0.45)] outline-none lg:hidden">
