...
export function DashboardHeader({
  ...
  const visibleBellNotifications = requestNotifications + assignmentNotifications + noticeNotifications;
      ...
      <div className="ml-auto flex items-center gap-5">
        ...
        <div className="hidden items-center gap-2 text-[var(--foreground)] md:flex">
          ...
          <div className="flex items-baseline gap-1 font-mono tabular-nums">
            ...
            <span className="min-w-[34px] text-base font-bold leading-none tracking-[0.08em] text-[#4f5ef7]">
              {currentClock.seconds}
            </span>
            <span className="min-w-[38px] text-sm font-semibold uppercase leading-none tracking-[0.14em] text-[var(--muted-foreground)]">
              {currentClock.label}
            </span>
          </div>
        </div>
